...
public class PatientDL {
    ...
    public Patient getCurrentHospitalPatienByPatientID(ConnectionParameter cp, String patientID)
    {
        String whereClause = " WHERE [" + Constraint.PATIENT_ID + "]=?";
        return getCurrentHospitalPatien(whereClause, cp, patientID);
    }

    private Patient getCurrentHospitalPatien(String whereClause, ConnectionParameter cp ,String patientID) {

        Patient chp = new Patient();
